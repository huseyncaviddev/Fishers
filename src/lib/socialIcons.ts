export type SocialKey = "facebook" | "tiktok" | "whatsapp";
...
export const SOCIAL_URLS: Record<SocialKey, string> = {
  ...
  tiktok:
    process.env.NEXT_PUBLIC_SOCIAL_TIKTOK || "https://www.tiktok.com/@azerbaijanaquaculture",
  whatsapp:
    process.env.NEXT_PUBLIC_SOCIAL_WHATSAPP || "https://wa.me/994519115511",
};
